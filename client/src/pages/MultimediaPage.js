...
const MultimediaPage = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(collectionRef, (snapshot) => {
      const multimediaData = snapshot.docs
        ...
        .sort((a, b) => Date.parse(b.fechaSubida) - Date.parse(a.fechaSubida)); // 🛠️ Corrección de ordenación
  ...
  const totalPages = useMemo(() => Math.ceil(multimedia.length / itemsPerPage), [multimedia.length, itemsPerPage]);
